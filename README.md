...
Router startup warnings have two classes. One class is a configuration fault. It reports ignored configuration or a problem that added project configuration or pi credentials can stop. Slate always shows these faults.

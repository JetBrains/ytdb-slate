...
export function renderStartupSummary(style?: SummaryStyle): string[] {
	const lines: SummaryPart[][] = [
		...
		[["3. Design:", "heading"], [" a proved design risk or a track estimated above 100 counted lines needs a design before work. "], ["You validate and approve it", "action"], [". Only proved design risks add adversarial design reviewers."]],
		[["4. Tracks:", "heading"], [" workers implement and report approximate size. A proved risk adds reviewers. More than 100 counted lines adds a general reviewer unless the track changes only documents that neither ship as code nor run."]],

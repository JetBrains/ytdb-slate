...
| on | `.pi/slate.json` six | off | off | 4 | 3,918 | 58 |
| on | `.pi/slate.json` six | off | on | 5 | 4,988 | 80 |
| on | `.pi/slate.json` six | on | off | 5 | 3,937 | 58 |
| on | `.pi/slate.json` six | on | on | 6 | 5,007 | 80 |
| on | all 9 shipped | off | off | 4 | 4,473 | 61 |
| on | all 9 shipped | off | on | 5 | 5,543 | 83 |
| on | all 9 shipped | on | off | 5 | 4,492 | 61 |
| on | all 9 shipped | on | on | 6 | 5,562 | 83 |
...
- The routing rule is a live table with ONE ROW PER ROUTABLE MODEL,
  ...
  ships profiles for. In this snapshot it is 1,989 portable
  characters and adds 20 doctrine lines for six configured models;
  for all nine it is 2,544 characters and adds 23 lines. The six
  model rows are 147–182 characters; all nine are 147–183. The
...
| --- | ---: | --- | ---: | ---: | ---: | ---: |
| current `.pi/slate.json` dogfood config | 6 | real 2 units / 4 tools | 6 | 5,923 | 90 | ≈1,481 |
| stable maximal fixture | 9 | synthetic 2 units / 4 tools, every rendered field at its cap | 6 | 6,909 | 93 | ≈1,727 |
...
characters. The measured 6,909 leaves 291 characters, or 4.0 percent of the
7,200-character bound. A positive control adds one capped tool
and three copies of the largest measured model row. It measures 7,673 portable
characters and exceeds the bound by 473. These figures are verification budgets,
...
about 482 tokens to about 1,391 tokens. The current dogfood basis is about 1,481
tokens. The representative maximum is about 1,727 tokens, or 0.67 percent of the
default budget.

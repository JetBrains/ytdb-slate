...
After explicit adoption, a trusted handoff reloads the doctrine in the
successor session. Adoption also forces a reminder after the first eligible
tool result. This forced reminder does not need context usage or a reached
threshold.

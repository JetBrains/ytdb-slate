...
- **Re-run it after any change to a covered module or source path.** Covered production modules are:
  ...
  The workflow contract checks also read `docs/track-workflow.md`, `docs/review-rules.md`, and `docs/context-budget.md`. Re-run them after a change to dispatch inputs, reviewer private-input rules, the stuck-fix episode exception, or the measured reference and specialist charter blocks.

...
| maximal doctrine, 9 profiles plus draft PRs, writing, and capped worker fixture | 7 | **7,189** | 97 | 7,200 |
| positive control, one extra capped tool plus three maximum-growth model rows | 7 | **7,953** | — | must exceed 7,200 |

The maximal doctrine keeps 11 portable characters of reserve. That is 0.2
...
exceeds the bound by 753 characters.

...
| maximal doctrine, 9 profiles plus draft PRs, writing, and capped worker fixture | 6 | **6,930** | 93 | 7,200 |
| positive control, one extra capped tool plus three maximum-growth model rows | 6 | **7,694** | — | must exceed 7,200 |

The maximal doctrine keeps 270 portable characters of reserve. That is 3.8
...
exceeds the bound by 494 characters.
